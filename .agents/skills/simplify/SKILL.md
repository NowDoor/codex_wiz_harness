---
name: simplify
description: Use when the user asks to simplify, clean up, or refactor code while preserving behavior.
---
...
2. Identify complexity sources:
   ...
   - Over-engineered patterns for simple cases.
...
- Do not add comments to explain simple code.
